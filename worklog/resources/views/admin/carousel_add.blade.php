...
<html>
	...
	<body>
		<div class="wrap-container">
			<form style="width: 90%;padding-top: 20px;" action="" method="post" id="uploadF" class="layui-form" enctype="multipart/form-data" onsubmit="return false;">
						...
						<div class="layui-input-block url-input">
							<div id="carouselcode" class="carousel-image">
								<img class="carousel-img" src="{{url('img/admin/none.png')}}"/>
									...
									<input name="rotation_picture_file" type="file" id="uploadFile" value="" onchange="selectImage(this);"/>
								</div>
							</div>
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block url-input">
							<input type="text" name="rotation_click_url" required lay-verify="required" placeholder="请输入点击后链接" autocomplete="off" class="layui-input" id="carousel-inp">
						</div>
