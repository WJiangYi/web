...
<head>
    ...
    <script src="{{url('static/admin/js/index/member_add.js')}}" type="text/javascript" charset="utf-8"></script>
</head>
        ...
        <form class="layui-form" style="width: 90%;padding-top: 20px;" onsubmit="return false;" >
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="radio" name="status" value="2" title="可读可写">
                </div>

            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn layui-btn-normal member-sub-btn" lay-submit lay-filter="">提 交</button>
                </div>
            </div>
        </form>
    </div>
